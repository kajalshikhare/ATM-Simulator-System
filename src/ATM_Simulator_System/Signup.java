...
public class Signup extends JFrame implements ActionListener {
	...
	add(dateChooser);
        ...
        b.addActionListener(this); // set action for next button
    	...
    	//get values from text field
          ...
          try{
              ...
              if(t1.getText().equals("")){
                  JOptionPane.showMessageDialog(null, "Fill all the required fields");//if name is empty show msg pop-up
            }else{
                  Conn c1 = new Conn();
                  //insert into database
                  String query1 = "insert into signup values('"+formno+"','"+name+"','"+fname+"','"+dob+"','"+gender+"','"+email+"','"+marital+"','"+address+"','"+city+"','"+pincode+"','"+state+"')";
                  c1.s.executeUpdate(query1);//execute query with the help of statment
